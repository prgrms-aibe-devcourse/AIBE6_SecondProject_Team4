...
VALUES
    ('user01', '김철수', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '철수', 'user01@fitmate.com', 'USER', 'https://i.pravatar.cc/300?img=11', '서울', '운동 초보입니다.', '010-1111-1111', NOW(), NOW()),
    ('user02', '이영희', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '영희', 'user02@fitmate.com', 'USER', 'https://i.pravatar.cc/300?img=47', '부산', '다이어트가 목표입니다.', '010-2222-2222', NOW(), NOW()),
    ('user03', '박민준', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '민준', 'user03@fitmate.com', 'USER', 'https://i.pravatar.cc/300?img=13', '인천', '근육 키우고 싶어요.', '010-3333-3333', NOW(), NOW()),
    ('user04', '최유진', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '유진', 'user04@fitmate.com', 'USER', 'https://i.pravatar.cc/300?img=44', '서울', '자세 교정과 유연성 향상이 목표입니다.', '010-4444-0004', NOW(), NOW()),
    ('user05', '한지우', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '지우', 'user05@fitmate.com', 'USER', 'https://i.pravatar.cc/300?img=25', '부산', '꾸준히 운동할 수 있는 코치를 찾고 있습니다.', '010-5555-0005', NOW(), NOW()),
    ('trainer01', '최민호', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '최코치', 'trainer01@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=51', '서울', '10년 경력의 PT 전문 트레이너입니다.', '010-4444-4444', NOW(), NOW()),
    ('trainer02', '정상훈', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '정코치', 'trainer02@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=52', '부산', '수영, 필라테스 전문입니다.', '010-5555-5555', NOW(), NOW()),
    ('trainer03', '김태양', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '태양코치', 'trainer03@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=53', '서울', '필라테스 전문 트레이너입니다.', '010-6001-0003', NOW(), NOW()),
    ('trainer04', '이준호', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '준호코치', 'trainer04@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=54', '부산', '크로스핏 전문가입니다.', '010-6001-0004', NOW(), NOW()),
    ('trainer05', '박서연', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '서연코치', 'trainer05@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=29', '인천', '요가 10년 경력입니다.', '010-6001-0005', NOW(), NOW()),
    ('trainer06', '최민기', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '민기코치', 'trainer06@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=56', '대구', '헬스 전문 트레이너입니다.', '010-6001-0006', NOW(), NOW()),
    ('trainer07', '정하은', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '하은코치', 'trainer07@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=31', '광주', '수영 국가대표 출신입니다.', '010-6001-0007', NOW(), NOW()),
    ('trainer08', '한도윤', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '도윤코치', 'trainer08@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=59', '대전', '테니스 레슨 전문입니다.', '010-6001-0008', NOW(), NOW()),
    ('trainer09', '오지민', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '지민코치', 'trainer09@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=60', '서울', '골프 레슨 전문가입니다.', '010-6001-0009', NOW(), NOW()),
    ('trainer10', '서윤아', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '윤아코치', 'trainer10@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=32', '부산', '댄스 전문 강사입니다.', '010-6001-0010', NOW(), NOW()),
    ('trainer11', '강현우', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '현우코치', 'trainer11@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=62', '인천', '헬스, 크로스핏 트레이너입니다.', '010-6001-0011', NOW(), NOW()),
    ('trainer12', '윤소희', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '소희코치', 'trainer12@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=33', '서울', '필라테스, 요가 강사입니다.', '010-6001-0012', NOW(), NOW()),
    ('trainer13', '임재현', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '재현코치', 'trainer13@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=65', '대구', '수영 전문 트레이너입니다.', '010-6001-0013', NOW(), NOW()),
    ('trainer14', '신예진', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '예진코치', 'trainer14@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=35', '광주', '댄스, 요가 강사입니다.', '010-6001-0014', NOW(), NOW()),
    ('trainer15', '조성민', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '성민코치', 'trainer15@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=68', '대전', '헬스 전문 트레이너입니다.', '010-6001-0015', NOW(), NOW()),
    ('trainer16', '권나연', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '나연코치', 'trainer16@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=38', '서울', '테니스, 골프 트레이너입니다.', '010-6001-0016', NOW(), NOW()),
    ('trainer17', '문재호', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '재호코치', 'trainer17@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=70', '부산', '크로스핏 전문가입니다.', '010-6001-0017', NOW(), NOW()),
    ('trainer18', '백수진', '$2a$10$N4tjEvVAtSjNWpipNlM42ekDjrErWjsaEJgbV5HIEVkNv3WDRUSAS', '수진코치', 'trainer18@fitmate.com', 'TRAINER', 'https://i.pravatar.cc/300?img=40', '인천', '필라테스 전문 트레이너입니다.', '010-6001-0018', NOW(), NOW()),
...
SELECT (SELECT id FROM matching_request WHERE lesson_content = '체중 감량과 기초 체력 향상을 원합니다.' LIMIT 1),
...
WHERE m.user_id = 'trainer03'
  AND NOT EXISTS (SELECT 1
                  FROM trainer_available_times at
